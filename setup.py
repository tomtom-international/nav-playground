...
setup(
    ...
    author_email='migasiew.nk@gmail.com',
    classifiers=[
    ...
    entry_points={
        'console_scripts': [
            'nav_playground=nav_playground.cli:main',
        ],
    },
    ...
    name='nav_playground',
    packages=find_packages(include=['nav_playground']),
    setup_requires=setup_requirements,
    test_suite='tests',
    tests_require=test_requirements,
    url='https://github.com/tomtom-international/nav_playground',
